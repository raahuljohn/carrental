...
if(isset($_POST["car1"]))
{
   // $ford = "R:/XAMPP/htdocs/rental/ford.jpg";
    $_SESSION["car"] = "img/i10.jpg";
    $_SESSION["carname"] = "HYUNDAI";
    $_SESSION["price"] = "Rs.2000/Day";

    // $sql = "UPDATE rent set image = LOAD_FILE('$ford') WHERE name = '$name'";
...
if(isset($_POST["car2"]))
{
    ...
    // $toyota = "R:/XAMPP/htdocs/rental/toyota.jpg";
    $_SESSION["car"] = "img/figo.jpg";
    $_SESSION["carname"] = "FORD";
    $_SESSION["price"] = "Rs.2500/Day";
    // $sql = "UPDATE rent set image = LOAD_FILE('$toyota') WHERE name = '$name'";
    // if(mysqli_query($conn,$sql))
	// 		{
				//success
               // echo "SUCCESS";
...
if(isset($_POST["car3"]))
{
    ...
    // $benz = "R:/XAMPP/htdocs/rental/benz.jpg";
    $_SESSION["car"] = "img/zen.jpg";
    $_SESSION["carname"] = "SUZUKI";
    $_SESSION["price"] = "Rs.2000/Day";
    // $sql = "UPDATE rent set image = LOAD_FILE('$benz') WHERE name = '$name'";
    // if(mysqli_query($conn,$sql))
	// 		{
				//success
               // echo "SUCCESS";
                            ...
                            <div class="card-content">
                                <div class="row">
                                    <div class="col s12 l4">
                                        <div class="card-title center" id="title"><h5><b>Hyundai i10</b></h5></div>
                                        <p><img src="img/i10.jpg" id="ford" class="materialboxed"></p>
                                    </div>
                                    <div class="col s12 l4 ">
                                        <div style="padding-left:45px;" class="center container">
                                            ...
                                            <ul>
                                                ...
                                                <li id="fea"><i class="material-icons prefix">person</i><span>4</span></li>
                ...
                <div class="col s12 l12">
                    <div class="card">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12 l4">
                                    <div class="card-title center" id="title"><h5><b>Ford Figo</b></h5></div>
                                    <p><img src="img/figo.jpg" id="ford" class="materialboxed"></p>
                                </div>
                ...
                <div class="col s12 l12">
                    <div class="card">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12 l4">
                                    <div class="card-title center" id="title"><h5><b>Suzuki Zen</b></h5></div>
                                    <p><img src="img/zen.jpg" id="ford" class="materialboxed"></p>
                                </div>
